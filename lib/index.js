    ...
    output: {
      ...
      render(args, value) {
        ...
        if (daemonVer && extVer && daemonVer !== extVer) {
          blocks.push({
            type: "text",
            text: `⚠️ version drift: daemon ${value.version} vs extension ${value.extension_version} — the browser extension likely auto-updated. Re-audit the 17-action skill list and update the daemon.`
          });
        }
        return blocks;
      }
